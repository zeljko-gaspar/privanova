...
<body class="services-group-page">
    ...
    <main>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="txt-holder">
                        <h1>Services</h1>
                        <h2 class="mb-40">Beyond<br> GDPR Compliance</h2>
                ...
                <div class="txt-box-content different-colors row">
                    <div class="txt-box-item col-3">
                        <div class="txt-box-item-wrapper">
                            <div class="txt-holder">
                                <h2 class="main-color">GDPR<br>CONSULTING</h2>
                                <p>Privacy and data protection services designed to fit your GDPR compliance goals.</p>
                                <a class="border-btn text-uppercase" href="services-group.php#gdpr-consulting">Read more</a>
                            </div>
                        </div>
                    </div>
                    <div class="txt-box-item col-3">
                        <div class="txt-box-item-wrapper">
                            <div class="txt-holder">
                                ...
                                <a class="border-btn text-uppercase" href="services-group.php#dpo-on-demand">Read more</a>
                            </div>
                        </div>
                    </div>
                    <div class="txt-box-item col-3">
                        <div class="txt-box-item-wrapper">
                            <div class="txt-holder">
                                ...
                                <a class="border-btn text-uppercase" href="services-group.php#risk-management">Read more</a>
                            </div>
                        </div>
                    </div>
                    <div class="txt-box-item col-3">
                        <div class="txt-box-item-wrapper">
                            <div class="txt-holder">
                                ...
                                <a class="border-btn text-uppercase" href="services-group.php#privacy-training">Read more</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="gdpr-consulting" class="img-txt-section">
            <div class="container-fluid">
                <div class="row">
        ...
        <section id="dpo-on-demand" class="img-txt-section">
            <div class="container-fluid">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="txt-holder col-6 p-0 d-flex align-items-center main-bg-color">
                        <div class="txt-holder-wrapper">
                            ...
                            <a class="border-btn" target="_blank" href="mailto:contact@privanova.com">Get a quote!</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="privacy-training" class="img-txt-section">
            <div class="container-fluid">
                <div class="row">
                    <div class="img-holder col-6 order-md-2 p-0">
        ...
        <section id="risk-management" class="txt-icons-box-section fixed-bg" style="background:url(images/index-risk-bg-img.jpg) top center /cover">
            <div class="container-fluid">
